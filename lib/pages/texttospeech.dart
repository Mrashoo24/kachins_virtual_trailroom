...
class _TexttoSpeechState extends State<TexttoSpeech> {
  ...
  Future _getvoice() async {
    List<dynamic> voicesList = await flutterTts.getVoices;
    print(voicesList);
  }
  ...
  Future _speak() async {
    ...
    print(" Voices :  ${await flutterTts.getVoices}");
  }
  ...
  Widget _futureBuilderVoice() => FutureBuilder<dynamic>(
      future: _getLanguages(),
      builder: (BuildContext context, AsyncSnapshot<dynamic> snapshot) {
        if (snapshot.hasData) {
          return _languageDropDownSection(snapshot.data);
  ...
  Widget _DropDownVoice(dynamic voicelist) => Container(
      padding: EdgeInsets.only(top: 10.0),
      child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
        DropdownButton(
          value: language,
          items: getLanguageDropDownMenuItems(voicelist),
          onChanged: changedLanguageDropDownItem,
        ),
        Visibility(
          visible: isAndroid,
